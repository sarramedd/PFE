...
export class ProjectMemberService {
  ...
  addMember(projectId: number, userId: number, roleInProject: string): Observable<ProjectMember> {
    const body = {
  ...
  updateRole(projectId: number, userId: number, roleInProject: string): Observable<ProjectMember> {

...
export class ManageMembersComponent implements OnInit {
  ...
  selectedRole: ProjectMemberRole = ProjectMemberRole.MEMBER;
  searchQuery    = '';
  ...
  roles = [
    ...
    { value: ProjectMemberRole.MEMBER, label: 'Member' }
  ];
  ...
  addMember(): void {
    ...
    this.memberService.addMember(this.project.id, this.selectedUserId, this.selectedRole).subscribe({
      next: () => {
        ...
        this.selectedUserId = null;
        this.selectedRole   = ProjectMemberRole.MEMBER;
        this.searchQuery    = '';
        this.filteredUsers  = [];
        this.memberService.getMembers(this.project.id).subscribe(data => {
          this.members = data;
  ...
  updateRole(member: ProjectMember, newRole: ProjectMemberRole): void {
  ...
  getRoleClass(role: ProjectMemberRole | string): string {
